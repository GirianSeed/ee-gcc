...
/* CYGNUS LOCAL sibcall/law */
extern void jump_optimize_minimal	PROTO ((rtx));
/* END CYGNUS LOCAL */
...
/* CYGNUS LOCAL sibcall/law */
/* In sibcall.c */
extern void optimize_sibling_and_tail_recursive_calls PROTO ((void));
extern void reemit_block_notes_from_seq PROTO ((rtx, rtx));
void reemit_block_notes_from_sequence	PROTO ((rtx, rtx));
/* END CYGNUS LOCAL */
#endif /* _RTL_H */
