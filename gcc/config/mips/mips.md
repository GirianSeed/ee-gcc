...
(define_attr "cpu"
  "default,r3000,r3900,r6000,r4000,r4100,r4300,r4600,r4650,r5000,r5400,r5900,r8000" ; pattern-sanitize-r5900-1  CYGNUS LOCAL vr5400/raeburn
...
(define_function_unit "memory" 1 0
  (and (eq_attr "type" "load")
       (eq_attr "cpu" "!r3000,r3900,r4600,r4650,r4100,r4300,r5000,r5400,r5900")) ; pattern-sanitize-r5900-1  CYGNUS LOCAL vr5400/raeburn
  3 0)
...
;; CYGNUS LOCAL law
(define_function_unit "memory"   1 0
  (and (eq_attr "type" "store") (eq_attr "cpu" "!r5900")) 1 0) ; pattern-sanitize-r5900-2

(define_function_unit "memory"   1 0
  (and (eq_attr "type" "xfer") (eq_attr "cpu" "!r5900")) 2 0) ; pattern-sanitize-r5900-2

(define_function_unit "imuldiv"  1 0
  (and (eq_attr "type" "hilo")
       (eq_attr "cpu" "!r5900")) ; pattern-sanitize-r5900-2
  1 3)

(define_function_unit "imuldiv"  1 0
  (and (eq_attr "type" "imul")
       (eq_attr "cpu" "!r3000,r3900,r4000,r4600,r4650,r4100,r4300,r5000,r5400,r5900")) ; pattern-sanitize-r5900-1  CYGNUS LOCAL vr5400/raeburn
  17 17)
;; END CYGNUS LOCAL
...
(define_function_unit "adder" 1 1
  (and (eq_attr "type" "fcmp") (eq_attr "cpu" "!r3000,r3900,r6000,r4300,r5000,r5400,r5900")) ; pattern-sanitize-r5900-1  CYGNUS LOCAL vr5400/raeburn
  3 0)
...
(define_function_unit "adder" 1 1
  (and (eq_attr "type" "fadd") (eq_attr "cpu" "!r3000,r3900,r6000,r4300,r5400,r5900")) ; pattern-sanitize-r5900-1  CYGNUS LOCAL vr5400/raeburn
  4 0)
...
(define_function_unit "adder" 1 1
  (and (eq_attr "type" "fabs,fneg")
       (eq_attr "cpu" "!r3000,r3900,r4600,r4650,r4300,r5000,r5400,r5900")) ; pattern-sanitize-r5900-1  CYGNUS LOCAL vr5400/raeburn
  2 0)
...
(define_function_unit "mult" 1 1
  (and (eq_attr "type" "fmul")
       (and (eq_attr "mode" "SF")
	    (eq_attr "cpu" "!r3000,r3900,r6000,r4600,r4650,r4300,r5000,r5400,r5900"))) ; pattern-sanitize-r5900-1  CYGNUS LOCAL vr5400/raeburn
  7 0)
...
(define_function_unit "divide" 1 1
  (and (eq_attr "type" "fsqrt,frsqrt") ; CYGNUS LOCAL vr5400/raeburn
       (and (eq_attr "mode" "SF") (eq_attr "cpu" "!r4600,r4650,r4300,r5000,r5400,r5900"))) ; pattern-sanitize-r5900-1  CYGNUS LOCAL vr5400/raeburn
  54 0)
...
(define_function_unit "alu" 2 0
  (and (eq_attr "type" "move,arith,darith,icmp,nop,branch,jump,call")
...
(define_insn "mulsi3_mult3"
  ...
  "(GENERATE_MULT3
    ...
    || TARGET_MAD)
   && !TARGET_MIPS5900" ;; pattern-sanitize-r5900-3 CYGNUS LOCAL law
  "*
{
...
(define_expand "muldi3"
  ...
  "TARGET_64BIT && !TARGET_MIPS5900" ;; pattern-sanitize-r5900-3 CYGNUS LOCAL law
...
(define_insn "muldi3_internal"
  [(set (match_operand:DI 0 "register_operand" "=l")
   ...
   (clobber (match_scratch:DI 3 "=h"))
   (clobber (match_scratch:DI 4 "=a"))]
  "TARGET_64BIT && mips_cpu != PROCESSOR_R4000 && !TARGET_MIPS16 && !TARGET_MIPS5900" ;; pattern-sanitize-r5900-3 CYGNUS LOCAL law
  "dmult\\t%1,%2"
  [(set_attr "type"	"imul")
   (set_attr "mode"	"DI")
   (set_attr "length"	"1")])
...
(define_insn "muldi3_internal2"
  ...
  "TARGET_64BIT && (GENERATE_MULT3 || mips_cpu == PROCESSOR_R4000 || TARGET_MIPS16) && !TARGET_MIPS5900" ;; pattern-sanitize-r5900-3 CYGNUS LOCAL law
  "*
{
  if (GENERATE_MULT3)
...
(define_insn "mulsidi3_64bit"
  ...
  "TARGET_64BIT && !TARGET_MIPS5900 && GET_CODE (operands[3]) == GET_CODE (operands[4])" ;; pattern-sanitize-r5900-3 CYGNUS LOCAL law
  "*
{
  if (GET_CODE (operands[3]) == SIGN_EXTEND)
    return \"mult\\t%1,%2\";
...
(define_insn "xmulsi3_highpart_internal"
  ...
  "! TARGET_MIPS5400 && !TARGET_MIPS5900 && GET_CODE (operands[3]) == GET_CODE (operands[4])" ;; CYGNUS LOCAL vr5400/raeburn ;; pattern-sanitize-r5900-3 CYGNUS LOCAL law
  "*
{
  if (GET_CODE (operands[3]) == SIGN_EXTEND)
    return \"mult\\t%1,%2\";
  ...
  [(set (match_operand:SI 0 "register_operand" "=l")
   ...
   (set (match_operand:SI 3 "register_operand" "=h")
	(mod:SI (match_dup 1)
		(match_dup 2)))
   (clobber (match_scratch:SI 6 "=a"))]
  "optimize && !TARGET_MIPS5900" ;; pattern-sanitize-r5900-3 CYGNUS LOCAL law
  "div\\t$0,%1,%2"
  [(set_attr "type"	"idiv")
   (set_attr "mode"	"SI")
   (set_attr "length"	"1")])
...
(define_expand "divmoddi4"
  ...
  "TARGET_64BIT && optimize && !TARGET_MIPS5900" ;; pattern-sanitize-r5900-3 CYGNUS LOCAL law
  "
{
  rtx label;
...
(define_insn "fix_truncsfsi2"
  ...
  "TARGET_HARD_FLOAT && !TARGET_MIPS5900" ;; pattern-sanitize-r5900-3 CYGNUS LOCAL law
  "*
{
  rtx xoperands[10];
...
(define_insn "movti_internal"
  [(set (match_operand:TI 0 "nonimmediate_operand" "=d,d,d,R,m,d,d,d,d,d,d")
	(match_operand:TI 1 "movti_operand" "d,R,m,d,d,J,I,K,L,M,i"))]
  "TARGET_MIPS5900
   && (register_operand (operands[0], TImode)
  ...
  por\\t%0,%.,%.\;li\\t%0,%1 \\t\\t\\t# ori
  por\\t%0,%.,%.\;li\\t%0,%1 \\t\\t\\t# lui
  por\\t%0,%.,%.\;li\\t%0,%1 \\t\\t\\t# general li macro
  li\\t%0,%M1\;pcpyld\\t%0,%0,%.\;li\\t%0,%L1"
  [(set_attr "type"	"move,load,load,store,store,move,move,move,move,move,move")
...
;; The general li macro on a 64 bit machine can be up to 7 instructions long.
   (set_attr "length"	"1,1,1,1,1,1,2,2,2,8,15")])
...
(define_insn "movdf_internal2"
  ...
  "(TARGET_SOFT_FLOAT || TARGET_SINGLE_FLOAT) && !TARGET_MIPS16 && !TARGET_64BIT
   && (register_operand (operands[0], DFmode)
       || register_operand (operands[1], DFmode)
       || (GET_CODE (operands[1]) == CONST_INT && INTVAL (operands[1]) == 0)
       || operands[1] == CONST0_RTX (DFmode))"
...
{
  if (TARGET_MIPS5900)
    return mips_fill_delay_slot (\"c.olt.s\\t%Z0%1,%2\",
				 DELAY_FCMP, operands, insn);
...
{
  if (TARGET_MIPS5900)
    return mips_fill_delay_slot (\"c.ole.s\\t%Z0%1,%2\",
				 DELAY_FCMP, operands, insn);
...
{
  if (TARGET_MIPS5900)
    return mips_fill_delay_slot (\"c.olt.s\\t%Z0%2,%1\",
				 DELAY_FCMP, operands, insn);
...
{
  if (TARGET_MIPS5900)
    return mips_fill_delay_slot (\"c.ole.s\\t%Z0%2,%1\",
				 DELAY_FCMP, operands, insn);
...
(define_insn ""
  ...
  "mips_isa >= 4 || TARGET_MIPS5900" ;; pattern-sanitize-r5900-3 CYGNUS LOCAL law
  "@
    mov%B4\\t%0,%z2,%1
    mov%b4\\t%0,%z3,%1"
  [(set_attr "type" "move")
