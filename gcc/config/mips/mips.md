  ...
  "
{
  ...
  /* For constants other than zero into memory.  We do not know how the
     instructions used to build constants modifiy the upper 64 bits
...
(define_insn "movti_internal"
  [(set (match_operand:TI 0 "nonimmediate_operand" "=d,d,d,d,R,m")
	(match_operand:TI 1 "reg_or_mem_or_0_operand" "d,J,R,m,d,d"))]
  "TARGET_MIPS5900
   && (register_operand (operands[0], TImode)
