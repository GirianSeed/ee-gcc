...
/* CYGNUS LOCAL sibcall/law */
  ...
  /* Walk the insn chain and emit sibling epilogues before any sibling
     call sites.

     ?!? This does not place the sibling call epilogue insns into any
     particular basic block.

     ?!? Any need to emit USE insns?  */
  {
    rtx insn;
