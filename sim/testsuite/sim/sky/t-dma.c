...
#define DMA_D0_CHCR	(unsigned*) 0xb0008000
...
#define DMA_D0_MADR	(unsigned*) 0xb0008010
#define DMA_D0_QWC	(unsigned*) 0xb0008020
#define DMA_D0_TADR	(unsigned*) 0xb0008030
#define DMA_D0_ASR0	(unsigned*) 0xb0008040
#define DMA_D0_ASR1	(unsigned*) 0xb0008050
#define DMA_D0_PKTFLAG	(unsigned*) 0xb0008060	/* virtual reg to indicate presence of tag in data */

#define DMA_D1_CHCR	(unsigned*) 0xb0009000
#define DMA_D1_MADR	(unsigned*) 0xb0009010
#define DMA_D1_QWC	(unsigned*) 0xb0009020
#define DMA_D1_TADR	(unsigned*) 0xb0009030
#define DMA_D1_ASR0	(unsigned*) 0xb0009040
#define DMA_D1_ASR1	(unsigned*) 0xb0009050
#define DMA_D1_PKTFLAG	(unsigned*) 0xb0009060	/* virtual reg to indicate presence of tag in data */ 

#define DMA_D2_CHCR	(unsigned*) 0xb000a000
#define DMA_D2_MADR	(unsigned*) 0xb000a010
#define DMA_D2_QWC	(unsigned*) 0xb000a020
#define DMA_D2_TADR	(unsigned*) 0xb000a030
#define DMA_D2_ASR0	(unsigned*) 0xb000a040
#define DMA_D2_ASR1	(unsigned*) 0xb000a050
#define DMA_D2_PKTFLAG	(unsigned*) 0xb000a060	/* virtual reg to indicate presence of tag in data */ 

#define DMA_D_CTRL	(unsigned*) 0xb000e000
#define DMA_D_CTRL__DMAE	0x00000001
#define DMA_D_STAT	(unsigned*) 0xb000e010
#define DMA_D_STAT__TOGGLE	0x63ff0000
#define DMA_D_STAT__CLEAR	0x0000e3ff
#define DMA_D_PCR	(unsigned*) 0xb000e020
...
#define DMA_D_SQWC	(unsigned*) 0xb000e030
#define DMA_D_RBSR	(unsigned*) 0xb000e040
#define DMA_D_RBOR	(unsigned*) 0xb000e050
#define DMA_D_STADR	(unsigned*) 0xb000e060
...
#define DMA_TAG_IRQ	0x80000000;
    ...
    *reg = 0x00012340;
    reg = DMA_D1_CHCR;
    printf ("Ready...\n");
    *reg = DMA_Dn_CHCR__STR | DMA_Dn_CHCR__MOD_NORM | DMA_Dn_CHCR__DIR;
    ...
    *reg = 51;
    printf ("Ready...\n");
    printf ("(We should get an addr-not-qword-aligned msg, ");
    printf ("but we don't care what the addr is - 0x???????1_0c000001)\n");
    reg = DMA_D0_CHCR;
    *reg = DMA_Dn_CHCR__STR | DMA_Dn_CHCR__TTE | DMA_Dn_CHCR__MOD_CHAIN | DMA_Dn_CHCR__DIR;
