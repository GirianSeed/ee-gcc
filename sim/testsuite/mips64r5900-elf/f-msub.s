...
test_msub1:	
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 1 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 2 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 4 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 5 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 6 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 7 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 8 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 9 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 10 0x00008011 $f3 0x7fffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 13 0x00008011 $f3 0x7fffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 14 0x00008011 $f3 0x7fffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 15 0x00008011 $f3 0x7fffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 44 0x00008011 $f3 0x7fffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 31 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 32 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 33 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 43 0x00008011 $f3 0x7fffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 51 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 52 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 53 0x00008011 $f3 0xffffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 61 0x00008011 $f3 0x7fffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 62 0x00008011 $f3 0x7fffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 63 0x00008011 $f3 0x7fffffff
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 5 0x00000001 $f3 0x80000000
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 6 0x00000001 $f3 0x00000000
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 7 0x00000001 $f3 0x00000000
	...
	clearfcsr
	msub.s $f3, $f1, $f2
	checkfpx 8 0x00000001 $f3 0x80000000
