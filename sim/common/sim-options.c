...
static const OPTION standard_options[] =
{
  { {"verbose", no_argument, NULL, OPTION_VERBOSE},
      'v', NULL, DISPLAY_OPTIONAL("Verbose output"),
      standard_option_handler, DISPLAY_OPTIONAL(NULL) },

#if defined (SIM_HAVE_BIENDIAN) /* ??? && WITH_TARGET_BYTE_ORDER == 0 */
  { {"endian", required_argument, NULL, OPTION_ENDIAN},
      'E', "big|little", DISPLAY_OPTIONAL("Set endianness"),
      standard_option_handler, DISPLAY_OPTIONAL(NULL) },
#endif
  ...
  { {"alignment", required_argument, NULL, OPTION_ALIGNMENT},
      '\0', "strict|nonstrict|forced", DISPLAY_OPTIONAL("Set memory access alignment"),
      standard_option_handler, DISPLAY_OPTIONAL(NULL) },
  ...
  { {"do-command", required_argument, NULL, OPTION_DO_COMMAND},
      '\0', "COMMAND", DISPLAY_OPTIONAL("")/*undocumented*/,
      standard_option_handler, DISPLAY_OPTIONAL(NULL) },
  ...
  { {"architecture", required_argument, NULL, OPTION_ARCHITECTURE},
      '\0', "MACHINE", DISPLAY_OPTIONAL("Specify the architecture to use"),
      standard_option_handler, DISPLAY_OPTIONAL(NULL) },
  { {"architecture-info", no_argument, NULL, OPTION_ARCHITECTURE_INFO},
      '\0', NULL, DISPLAY_OPTIONAL("List supported architectures"),
      standard_option_handler, DISPLAY_OPTIONAL(NULL) },
  ...
  { {"target", required_argument, NULL, OPTION_TARGET},
      '\0', "BFDNAME", DISPLAY_OPTIONAL("Specify the object-code format for the object files"),
      standard_option_handler, DISPLAY_OPTIONAL(NULL) },
