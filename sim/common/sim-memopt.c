...
static const OPTION memory_options[] =
{
  { {"memory-delete", required_argument, NULL, OPTION_MEMORY_DELETE },
      '\0', "ADDRESS|all", DISPLAY_OPTIONAL("Delete memory at ADDRESS (all addresses)"),
      memory_option_handler, DISPLAY_OPTIONAL(NULL) },
  { {"delete-memory", required_argument, NULL, OPTION_MEMORY_DELETE },
      '\0', DISPLAY_OPTIONAL("ADDRESS"), NULL,
      memory_option_handler, DISPLAY_OPTIONAL(NULL) },

  { {"memory-region", required_argument, NULL, OPTION_MEMORY_REGION },
      '\0', "ADDRESS,SIZE[,MODULO]", DISPLAY_OPTIONAL("Add a memory region"),
      memory_option_handler, DISPLAY_OPTIONAL(NULL) },

  { {"memory-alias", required_argument, NULL, OPTION_MEMORY_ALIAS },
      '\0', "ADDRESS,SIZE{,ADDRESS}", DISPLAY_OPTIONAL("Add memory shadow"),
      memory_option_handler, DISPLAY_OPTIONAL(NULL) },

  { {"memory-size", required_argument, NULL, OPTION_MEMORY_SIZE },
      '\0', "SIZE", DISPLAY_OPTIONAL("Add memory at address zero"),
      memory_option_handler, DISPLAY_OPTIONAL(NULL) },

  { {"memory-fill", required_argument, NULL, OPTION_MEMORY_FILL },
      '\0', "VALUE", DISPLAY_OPTIONAL("Fill subsequently added memory regions"),
      memory_option_handler, DISPLAY_OPTIONAL(NULL) },

  { {"memory-clear", no_argument, NULL, OPTION_MEMORY_CLEAR },
      '\0', NULL, DISPLAY_OPTIONAL("Clear subsequently added memory regions"),
      memory_option_handler, DISPLAY_OPTIONAL(NULL)  },

  { {"memory-info", no_argument, NULL, OPTION_MEMORY_INFO },
      '\0', NULL, DISPLAY_OPTIONAL("List configurable memory regions"),
      memory_option_handler, DISPLAY_OPTIONAL(NULL) },
  { {"info-memory", no_argument, NULL, OPTION_MEMORY_INFO },
      '\0', NULL, DISPLAY_OPTIONAL(NULL),
      memory_option_handler, DISPLAY_OPTIONAL(NULL) },
