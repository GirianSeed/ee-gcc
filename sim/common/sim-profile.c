...
static const OPTION profile_options[] = {
  ...
  { {"profile-pc-frequency", required_argument, NULL, 'F'},
      'F', "PC PROFILE FREQUENCY", DISPLAY_OPTIONAL("Specified PC profiling frequency"),
      profile_option_handler, DISPLAY_OPTIONAL(NULL) },
  { {"profile-pc-size", required_argument, NULL, 'S'},
      'S', "PC PROFILE SIZE", DISPLAY_OPTIONAL("Specify PC profiling size"),
      profile_option_handler, DISPLAY_OPTIONAL(NULL) },
  { {"profile-pc-granularity", required_argument, NULL, OPTION_PROFILE_PC_GRANULARITY},
      '\0', "PC PROFILE GRANULARITY", DISPLAY_OPTIONAL("Specify PC profiling sample coverage"),
      profile_option_handler, DISPLAY_OPTIONAL(NULL) },
  { {"profile-pc-range", required_argument, NULL, OPTION_PROFILE_PC_RANGE},
      '\0', "BASE,BOUND", DISPLAY_OPTIONAL("Specify PC profiling address range"),
      profile_option_handler, DISPLAY_OPTIONAL(NULL) },
