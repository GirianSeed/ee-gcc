...
static const OPTION mips_options[] =
{
  { {"dinero-trace", optional_argument, NULL, OPTION_DINERO_TRACE},
      '\0', "on|off", DISPLAY_OPTIONAL("Enable dinero tracing"),
      mips_option_handler, DISPLAY_OPTIONAL(NULL) },
  { {"dinero-file", required_argument, NULL, OPTION_DINERO_FILE},
      '\0', "FILE", DISPLAY_OPTIONAL("Write dinero trace to FILE"),
      mips_option_handler, DISPLAY_OPTIONAL(NULL) },
...
#define BOARD_JMR3904_DEBUG "jmr3904debug"
    ...
    , DISPLAY_OPTIONAL("Customize simulation for a particular board."),
    mips_option_handler, DISPLAY_OPTIONAL(NULL) },
		  ...
		  int cause, ...)
{
  ...
  /* NB: SIM_CPU_EXCEPTION_TRIGGER call is absent here due to
     conflicts with sky_engine_halt_hook. */
