...
/* Disable exception trigger/suspend/resume hooks, since these
   conflict with the sky halt/resume hooks. */
#undef SIM_CPU_EXCEPTION_TRIGGER
#undef SIM_CPU_EXCEPTION_SUSPEND
#undef SIM_CPU_EXCEPTION_RESUME
