...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      return m32rxf_h_accum_get (current_cpu);
#endif
    default :
      abort ();
    }
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      m32rxf_h_accum_set (current_cpu, newval);
      break;
#endif
    default :
      abort ();
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      return m32rxf_h_accums_get (current_cpu, regno);
#endif
    default :
      abort ();
    }
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      m32rxf_h_accums_set (current_cpu, regno, newval);
      break;
#endif
    default :
      abort ();
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      return m32rxf_h_bbpsw_get (current_cpu);
#endif
    default :
      abort ();
    }
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      m32rxf_h_bbpsw_set (current_cpu, newval);
      break;
#endif
    default :
      abort ();
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      return m32rxf_h_bpsw_get (current_cpu);
#endif
    default :
      abort ();
    }
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      m32rxf_h_bpsw_set (current_cpu, newval);
      break;
#endif
    default :
      abort ();
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      return m32rxf_h_cond_get (current_cpu);
#endif
    default :
      abort ();
    }
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      m32rxf_h_cond_set (current_cpu, newval);
      break;
#endif
    default :
      abort ();
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      return m32rxf_h_lock_get (current_cpu);
#endif
    default :
      abort ();
    }
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      m32rxf_h_lock_set (current_cpu, newval);
      break;
#endif
    default :
      abort ();
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      return m32rxf_h_pc_get (current_cpu);
#endif
    default :
      abort ();
    }
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      m32rxf_h_pc_set (current_cpu, newval);
      break;
#endif
    default :
      abort ();
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      return m32rxf_h_psw_get (current_cpu);
#endif
    default :
      abort ();
    }
...
#ifdef HAVE_CPU_M32RXF
    case bfd_mach_m32rx : 
      m32rxf_h_psw_set (current_cpu, newval);
      break;
#endif
    default :
      abort ();
